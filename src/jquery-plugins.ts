export default function jqueryPlugins($: any) {
  ...
  $.fn.ellipsisHtmlFixed = function (chars: number, cb: Function) {
    return this.each(function () {
      ...
      (<any>$self).toggle = function () {
        ...
        $toggleButton.one("click", function (e: any) {
          e.preventDefault();
          $self.toggle();
        });
  ...
  function documentHandler() {
    ...
    $current.mousemove(function (e: any) {
  ...
  $.fn.removeLastWord = function (chars: number = 8, depth: number = 0) {
    return this.each(function () {
      ...
      if ($self.contents().length > 0) {
        const $lastElement: any = $self.contents().last();
